            ...
            function u(t, n) {
                ...
                for (var U, T, j, S, V, C, A = new l(t); !A.eos();) {
                    if (U = A.pos, j = A.scanUntil(a))
                        for (var I = 0, R = j.length; R > I; ++I) S = j.charAt(I), s(S) ? v.push(d.length) : y = !0, d.push(["text", S, U, U + 1]), U += 1, "\n" === S && i();
                    if (!A.scan(a)) break;
            ...
            l.prototype.eos = function() {
                ...
                if (r.hasOwnProperty(e)) n = r[e];
                    ...
                    for (var o, s, a = this, u = !1; a;) {
                        if (e.indexOf(".") > 0)
                            for (n = a.view, o = e.split("."), s = 0; null != n && s < o.length;) s === o.length - 1 && (u = i(n, o[s])), n = n[o[s++]];
                ...
                if (u) {
                    if (g(u))
                        for (var c = 0, p = u.length; p > c; ++c) a += this.renderTokens(e[4], n.push(u[c]), r, i);
    ...
    11: [function(require, module, exports) {
        ...
        module.exports = function(e, o) {
            ...
            if (t = t.replace(/\/v4$/, ""), t += e, config.REQUIRE_ACCESS_TOKEN) {
                ...
                t += -1 !== t.indexOf("?") ? "&access_token=" : "?access_token=", t += o
            }
            return t
            ...
            var t = e.split("mapbox://styles/")[1],
                s = module.exports("/styles/v1/" + t, o).replace("http://", "https://");
            return s
        };
    }, {
        "../package.json": 7,
    ...
    12: [function(require, module, exports) {
        ...
        module.exports = function(e, t) {
            ...
            return util.strict(e, "string"), -1 === e.indexOf("/") && (e = format_url("/geocoding/v5/" + e + "/{query}.json", t.accessToken, 5)), n.getURL = function() {
                ...
                return request(n.queryURL(o), function(e, r) {
                    t(e, r)
                }), n
            }, n
        };
    ...
    13: [function(require, module, exports) {
        ...
        var geocoder = require("./geocoder"),
            ...
            GeocoderControl = L.Control.extend({
                ...
                _geocode: function(t) {
                    return L.DomEvent.preventDefault(t), "" === this._input.value ? this._updateSubmit() : (L.DomUtil.addClass(this._container, "searching"), void this.geocoder.query(L.Util.extend({
                        query: this._input.value,
                        proximity: this.options.proximity ? this._map.getCenter() : !1
                    }, this.options.queryOptions), this._updateSubmit))
                },
                _autocomplete: function() {
                    return this.options.autocomplete ? "" === this._input.value ? this._updateAutocomplete() : void this.geocoder.query(L.Util.extend({
                        query: this._input.value,
                        proximity: this.options.proximity ? this._map.getCenter() : !1
                    }, this.options.queryOptions), this._updateAutocomplete) : void 0
                }
            });
            ...
            StyleLayer = L.TileLayer.extend({
                ...
                _getAttribution: function(t) {
                    ...
                    request(i, L.bind(function(e, r) {
                        e && (util.log("could not load Mapbox style at " + i), this.fire("error", {
                            error: e
                        }));
                        var o = [];
                        ...
                        request(format_url.tileJSON(o.join(), this.options.accessToken), L.bind(function(i, e) {
                            i ? (util.log("could not load TileJSON at " + t), this.fire("error", {
                                error: i
                            })) : e && (util.strict(e, "object"), this.options.attribution = this.options.sanitizer(e.attribution), this._tilejson = e, this.fire("ready"))
                        }, this))
                    }, this))
                },
                setUrl: null,
